    ...
    <div className="container">
      <div style={{ width: "100%" }}>
        <div className="about-me">
          ...
          {/* <PhotoGrid /> */}
          <strong className="resume-header" id="CZ">
            CZECH REPUBLIC
          </strong>
      
          <PragueGrid1 /><br></br>
          <strong className="resume-header" id="BA">
            THE U.S. NAVY BLUE ANGELS
          </strong>
          
          <BlueAngelsGrid1 /><br></br>
          <strong className="resume-header" id="BH">
            THE GREAT BLUE HERON
          </strong>
        
          <BlueHeronGrid1 /><br></br>
          <strong className="resume-header" id="IRL">
            IRELAND
          </strong>
